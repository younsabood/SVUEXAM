...
namespace SVUEXAM
{
    internal class SQL
    {
        ...
        public static int Update(string tableName, SqlParameter[] parameters, string whereClause)
        {
            try
            {
        ...
        public static int Delete(string tableName, string whereClause, params SqlParameter[] parameters)
        {
            try
            {
